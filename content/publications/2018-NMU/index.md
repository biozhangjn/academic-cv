...
# 对应旧版元数据，为您和第一作者 Yiping Wan 保留了共同第一作者（Equal contribution）的标注
author_notes:
  - "Equal contribution"
  - "Equal contribution"
...
# Publication type.
# 新版期刊规范：使用 CSL 标准的 'article-journal' 替换了旧版的数字代码 "2"
publication_types: ["article-journal"]

# Publication metadata — structured fields used by citation styles and BibTeX export.
publication:
  name: "Peptides"
  # volume: 101       # 新版要素：期刊卷号（可根据实际发表信息取消注释并填写，例如该文章发表于 101 卷）
  # issue: ""         # 新版要素：期刊期号
...
# Funders and grants. - 新版要素：基金项目支持
# funding:
...
hugoblox:
  ids:
    doi: "10.1016/j.peptides.2017.12.022"
    # arxiv: ""     # 新版预留的 arxiv 标识符

# Custom links
# 新版要素：整合了旧版的 url_pdf 等独立字段，未来有相关链接可直接在下方填写
# links:
#   - type: pdf
#     url: ""
#   - type: code
