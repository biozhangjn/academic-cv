...
# Author notes (optional) - 新版要素：用于标注共同第一作者或通讯作者
# author_notes:
#   - "Equal contribution"
#   - "Equal contribution"
...
# Publication type.
# 新版预印本规范：使用 CSL 标准的 'article-preprint' 替换了旧版的数字代码 "3"
...
# Custom links
# 旧版的 url_project 已经统一规范合并至此处，作为 Online Database 的数据源链接
links:
  - type: dataset
    name: Online Database
    url: "http://chickenatlas.avianscu.com/"
#   - type: pdf
#     url: ""
#   - type: code
#     url: ""
