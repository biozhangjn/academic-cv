...
# Authors
# 已经将您的名字 "Jiannan Zhang*" 转换为统一的标识符 "me"，并将其余作者名进行了规范
authors:
  - Tianjiao Huang
  - Jiancheng Su
  - Xinglong Wang
...
# 依据您和 Yajun Wang 教授的原文件星号（*）标注，在第 8 个和第 9 个位置精准补充了通讯作者身份标识
author_notes:
  - ""
  - ""
  - ""
...
# publication_short: "Animals"
  # volume: 14        # 新版要素：期刊卷号（可根据实际发表信息取消注释并填写，该文章发表于 14 卷）
  # issue: 7         # 新版要素：期刊期号
...
# 新版规范：DOI 采用结构化字段，剥离了原有的前缀与无效路径
hugoblox:
  ids:
